...
export default function Home() {
  return (
      ...
      <main>
        ...
        <section id="features" className="py-16">
          <div className="container mx-auto px-4">
            <h3 className="text-3xl font-bold text-center font-serif mb-8">Our Products</h3>
    ...
    objectPosition: '0% 80%' 
                ...
                <span>
                <h4 className="text-xl font-bold font-serif mb-2">AVOCADO EXTRA VIRGIN OIL</h4>
                <p className="text-black font-serif border rounded-lg p-5 border rounded-lg bg-gray-50 mt-5">Our Avocado Extra Virgin Oil is produced using the cold press method to ensure the highest quality. Rich in vitamins and antioxidants, this oil is ideal for culinary use and cosmetic applications.</p>
                </span>
              </div>
                         <div className="bg-white flex p-6 rounded-lg shadow-md text-center">
    ...
    objectPosition: '0% 80%' 
                ...
                <span>
                <h4 className="text-xl font-bold font-serif mb-2">AVOCADO ORGANIC OIL</h4>
                <p className="text-black font-serif border rounded-lg p-5 border rounded-lg bg-gray-50 mt-5">Certified organic, our Avocado Organic Oil is free from pesticides and synthetic fertilizers. It retains all the natural goodness of avocados, making it perfect for health-conscious consumers. </p>
                </span>
              </div>
            <div className="bg-white flex p-6 rounded-lg shadow-md text-center">
                ...
                <span>
                <h4 className="text-xl font-bold font-serif mb-2">AVOCADO CRUDE OIL</h4>
                <p className="text-black font-serif border rounded-lg p-5 border rounded-lg bg-gray-50 mt-5">Our Avocado Crude Oil is minimally processed, maintaining its natural color and nutrients. It serves as a raw material for further refinement or direct use in various industries.</p>
                </span>
              </div>
            </div>
          </div>
        ...
        <section id="about" className="bg-gray-200 py-16">
          ...
          <section>
          <div className='bg-white p-10 text-center items-center text-black font-serif border rounded-lg'>
        ...
        <section>
          <div className='bg-gray-200 p-10 text-center items-center text-black font-serif border rounded-lg'>
          ...
          <section>
          <div className='bg-green-100 p-10 text-center items-center text-black font-serif border rounded-lg flex items-center flex-col'>
            ...
            <p className="text-center text-black max-w-2xl mx-auto font-serif p-5">
          ...
          <section>
          <div className='bg-white p-10 text-center items-center text-black font-serif border rounded-lg flex items-center flex-col'>
            ...
            <p className="text-center text-black max-w-2xl mx-auto font-serif p-5">
             We believe in giving back to the community. Our social responsibility initiatives include supporting local education, healthcare and infrastructure projects. We actively participate in community development programs, ensuring that our growth translates into broader societal benefits. 
                  ...
                  <section>
          <div className='bg-green-200 p-10 text-center items-center text-black font-serif border rounded-lg flex items-center flex-col'>
          ...
          <div className='bg-white p-10 text-center items-center text-black font-serif border rounded-lg flex items-center flex-col'>
            ...
            <p className="text-center text-black max-w-2xl mx-auto font-serif p-5">
             We aim to economically empower our farmers and employees through fair trade practices, competitive wages, and continuous capacity-building programs. By creating a stable and profitable market for avocados, we contribute to the economic upliftment of our community.
                   ...
                   <section>
          <div className='bg-gray-200 p-10 text-center items-center text-black font-serif border rounded-lg flex items-center flex-col'>
